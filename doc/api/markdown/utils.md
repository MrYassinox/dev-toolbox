...
**Returns:**
 ...
 - <b>`List[Image.Image]`</b>:  A list of PIL image objects in binary mode. 
...
**Raises:**
 ...
 - <b>`Exception`</b>:  If there is an error reading the image. 
...
writes_csvfile(
    ...
    dataset: Optional[list[dict], dict] = None,
...
**Args:**
 ...
 - <b>``name_csv` (str, optional)`</b>:  The name of the CSV file to be created. Defaults to 'data.csv'. 
 - <b>``field_names` (list[str], optional)`</b>:  A list of field names for the CSV columns.   Default is None, which auto-generates field names based on the dataset. 
 - <b>``dataset` (Union[list[dict], dict], optional)`</b>:  The data to be written to the CSV file.   If a dictionary is provided, each key represents a row, and its value is a dictionary of   column values. If a list of dictionaries is provided, each dictionary represents a row.  Default is None. 
 - <b>``n_index` (bool, optional)`</b>:  If True, an 'Index' column is added to the CSV file. Defaults to None. 
...
> - The function creates a new CSV file or overwrites an existing one with the same name. - Field names are auto-generated from the dataset if not provided. - The 'Index' column is added if `n_index` is set to True. 


---

<a href="https://github.com/MrYassinox/dev-toolbox/blob/main\DevToolbox\modules\utils.py#L4015"><img align="right" style="float:right;" src="https://img.shields.io/badge/-source-cccccc?style=flat-square"></a>

## <kbd>function</kbd> `check_is_network_available`

```python
check_is_network_available(
...
**Args:**
 ...
 - <b>``timeout` (int, optional)`</b>:  The timeout for the network request in seconds. Default is None. 
 - <b>``logs` (LoggerHandle, optional)`</b>:  An instance of the LoggerHandle class for logging purposes. Defaults to None. 



**Returns:**
 
 - <b>`bool`</b>:  True if the network is available, False otherwise. 


---

<a href="https://github.com/MrYassinox/dev-toolbox/blob/main\DevToolbox\modules\utils.py#L4038"><img align="right" style="float:right;" src="https://img.shields.io/badge/-source-cccccc?style=flat-square"></a>

## <kbd>function</kbd> `dict_to_namespace`

```python
dict_to_namespace(dictionary: dict)
```
...
**Args:**
 ...
 - <b>``dictionary` (dict)`</b>:  The dictionary to be converted. 



**Returns:**
 
 - <b>`SimpleNamespace`</b>:  A namespace with attributes corresponding to the dictionary keys. 
...
<a href="https://github.com/MrYassinox/dev-toolbox/blob/main\DevToolbox\modules\utils.py#L4061"><img align="right" style="float:right;" src="https://img.shields.io/badge/-source-cccccc?style=flat-square"></a>

## <kbd>function</kbd> `namespace_to_dict`

```python
namespace_to_dict(namespace: SimpleNamespace)
```
...
**Args:**
 ...
 - <b>``namespace` (SimpleNamespace)`</b>:  The namespace to be converted. 



**Returns:**
 
 - <b>`dict`</b>:  A dictionary containing the namespace attributes as key-value pairs. 
...
<a href="https://github.com/MrYassinox/dev-toolbox/blob/main\DevToolbox\modules\utils.py#L4086"><img align="right" style="float:right;" src="https://img.shields.io/badge/-source-cccccc?style=flat-square"></a>

## <kbd>function</kbd> `utils_image`

```python
utils_image(
    img: Union[ndarray, Image, str, bytes],
...
**Args:**
 ...
 - <b>``img` (Union[np.ndarray, Image.Image, str, bytes])`</b>:  The input image as a NumPy array, PIL.Image, file path, or image bytes. 
 - <b>``resize_shape` (tuple, optional)`</b>:  The desired image dimensions as (width, height). Defaults to None. 
 - <b>``convert_color` (str, optional)`</b>:  The desired color mode for the image ("L", "RGB", or "CMYK"). Defaults to None. 
 - <b>``logs` (LoggerHandle, optional)`</b>:  An instance of the LoggerHandle class for logging purposes. 



**Returns:**
 
 - <b>`Optional[Image.Image]`</b>:  The processed image as a PIL.Image object, or None if there was an error. 


---

<a href="https://github.com/MrYassinox/dev-toolbox/blob/main\DevToolbox\modules\utils.py#L4128"><img align="right" style="float:right;" src="https://img.shields.io/badge/-source-cccccc?style=flat-square"></a>

## <kbd>function</kbd> `load_image`

```python
load_image(
    file_or_url: str,
    mode_open: Optional[str] = None,
    mode_operation: Optional[str] = None,
    outputdir: Optional[str] = None,
    outputBytesIO: Optional[bool] = None,
...
**Args:**
 ...
 - <b>``file_or_url` (str)`</b>:  The path to load the image file or URL. 
 - <b>``mode_open` (str, optional)`</b>:  mode is an optional string that specifies the mode in which the file is opened, "r" reading or "b" binary or "rb" reading binary. Defaults to "r". 
 - <b>``mode_operation` (str, optional)`</b>:  If choice `"sys"` to open file with python system and `"pil"` operation to open file with Pillow. Defaults to "pil". 
 - <b>``outputdir` (str, optional)`</b>:  The directory path to save the file image. Defaults to None. 
 - <b>``outputBytesIO` (bool, optional)`</b>:  Whether to return the image as a BytesIO object. Defaults to None. 
 - <b>``stream` (bool, optional)`</b>:  Whether to stream the image data. Defaults to None. 
 - <b>``logs` (LoggerHandle, optional)`</b>:  An instance of the LoggerHandle class for logging purposes. 
...
**Returns:**
 ...
 - <b>`Image`</b>:  Return The Image as PIL object or as BufferedReader or binary object. 



**Raises:**
 
 - <b>`FileNotFoundError`</b>:  If the image file does not exist. 
 - <b>`URLError`</b>:  If the image URL cannot be loaded. 



**Notes:**

> - Look the args `outputdir`, `outputBytesIO` and `stream` working if the path image is "URL". - `mode_open`: The mode open file `"b"`and `"rb"` not work in `"pil"` operation. 


---

<a href="https://github.com/MrYassinox/dev-toolbox/blob/main\DevToolbox\modules\utils.py#L4194"><img align="right" style="float:right;" src="https://img.shields.io/badge/-source-cccccc?style=flat-square"></a>

## <kbd>function</kbd> `image_to_bytesIO`

```python
image_to_bytesIO(img: Union[Image, ndarray, str, bytes])
```
...
**Args:**
 ...
 - <b>``img` (Union[Image.Image, np.ndarray, str])`</b>:  The input image. It can be a PIL Image, a NumPy array, or a string representing the image path or bytes. 



**Raises:**
 
 - <b>`TypeError`</b>:  If the input is not a supported type or if there are other exceptions during the conversion. 



**Returns:**
 
 - <b>`io.BytesIO`</b>:  A BytesIO object containing the image data. 
...
<a href="https://github.com/MrYassinox/dev-toolbox/blob/main\DevToolbox\modules\utils.py#L4246"><img align="right" style="float:right;" src="https://img.shields.io/badge/-source-cccccc?style=flat-square"></a>

## <kbd>function</kbd> `resize_image_to_closest_dimension`

```python
resize_image_to_closest_dimension(
...
**Args:**
 ...
 - <b>``image` (Union[Image.Image, np.ndarray])`</b>:  The input image as a NumPy array or PIL.Image. 
 - <b>``dimensions` (List[Tuple[int, int]])`</b>:  A list of supported image dimensions as tuples (width, height). 



**Raises:**
 
 - <b>`ValueError`</b>:  If the input is not a NumPy array or PIL.Image. 



**Returns:**
 
 - <b>`Image.Image`</b>:  The processed image resized to the closest supported dimension. 
...
> - This function resizes the input image to the closest supported dimension specified in the dimensions list. It uses the minimum sum of absolute differences in width and height to find the closest dimension. The resizing is done using Lanczos resampling. 


---

<a href="https://github.com/MrYassinox/dev-toolbox/blob/main\DevToolbox\modules\utils.py#L4311"><img align="right" style="float:right;" src="https://img.shields.io/badge/-source-cccccc?style=flat-square"></a>

## <kbd>function</kbd> `resize_image_to_closest_max_pixels`

```python
resize_image_to_closest_max_pixels(
    image: Union[Image, ndarray],
...
**Args:**
 ...
 - <b>``image` (Union[Image.Image, np.ndarray])`</b>:  The input image as a NumPy array or PIL.Image. 
 - <b>``max_total_pixels` (int)`</b>:  The maximum total pixels allowed. Must be a positive number. 
...
**Raises:**
 ...
 - <b>`ValueError`</b>:  If the input is not a NumPy array or PIL.Image. 
 - <b>`ValueError`</b>:  If max_total_pixels is not a positive number. 



**Returns:**
 
 - <b>`Image.Image`</b>:  The resized image as a PIL.Image. 
...
> - This function resizes the input image to fit within the specified maximum total pixels while preserving the aspect ratio of the original image. 


---

<a href="https://github.com/MrYassinox/dev-toolbox/blob/main\DevToolbox\modules\utils.py#L4381"><img align="right" style="float:right;" src="https://img.shields.io/badge/-source-cccccc?style=flat-square"></a>

## <kbd>function</kbd> `closest_supported_dimensions_and_max_pixels`

```python
closest_supported_dimensions_and_max_pixels(
    shape: tuple[int, int],
    max_total_pixels: Optional[int] = None,
    supported_dimensions: Optional[list[tuple[int, int]]] = None
)
```
...
**Args:**
 ...
 - <b>``shape` (tuple[int, int])`</b>:  The original shape as a tuple of (width, height). 
 - <b>``max_total_pixels` (int, opstion)`</b>:  The maximum total pixels allowed. Must be a positive number. 
 - <b>``supported_dimensions` (list[tuple[int, int]], optional)`</b>:  List of supported dimensions as tuples (width, height). 
...
**Returns:**
 ...
 - <b>`tuple[int, int]`</b>:  The closest supported dimensions for the input shape. 
...
> - If both max_total_pixels and supported_dimensions are provided, the function will first check if the shape is within the limit. If it is, no resizing is needed. If it exceeds the limit, it will calculate the new dimensions to fit within the limit and then find the closest supported dimension. - If only max_total_pixels is provided, it will check if the shape is within the limit and resize if necessary. - If only supported_dimensions are provided, it will find the closest supported dimension. - If neither max_total_pixels nor supported_dimensions are provided, it returns the original shape. 


---

<a href="https://github.com/MrYassinox/dev-toolbox/blob/main\DevToolbox\modules\utils.py#L123"><img align="right" style="float:right;" src="https://img.shields.io/badge/-source-cccccc?style=flat-square"></a>

## <kbd>class</kbd> `LoggerHandle`
LoggerHandle functionality and exception handling in applications. 

<a href="https://github.com/MrYassinox/dev-toolbox/blob/main\DevToolbox\modules\utils.py#L125"><img align="right" style="float:right;" src="https://img.shields.io/badge/-source-cccccc?style=flat-square"></a>
...
<a href="https://github.com/MrYassinox/dev-toolbox/blob/main\DevToolbox\modules\utils.py#L171"><img align="right" style="float:right;" src="https://img.shields.io/badge/-source-cccccc?style=flat-square"></a>
...
```python
    ...
    onerror: Optional[<built-in function callable>] = <function LoggerHandle.<lambda> at 0x0000020D6F4AD280>,
...
<a href="https://github.com/MrYassinox/dev-toolbox/blob/main\DevToolbox\modules\utils.py#L399"><img align="right" style="float:right;" src="https://img.shields.io/badge/-source-cccccc?style=flat-square"></a>
...
<a href="https://github.com/MrYassinox/dev-toolbox/blob/main\DevToolbox\modules\utils.py#L269"><img align="right" style="float:right;" src="https://img.shields.io/badge/-source-cccccc?style=flat-square"></a>
...
<a href="https://github.com/MrYassinox/dev-toolbox/blob/main\DevToolbox\modules\utils.py#L373"><img align="right" style="float:right;" src="https://img.shields.io/badge/-source-cccccc?style=flat-square"></a>
...
<a href="https://github.com/MrYassinox/dev-toolbox/blob/main\DevToolbox\modules\utils.py#L426"><img align="right" style="float:right;" src="https://img.shields.io/badge/-source-cccccc?style=flat-square"></a>
...
<a href="https://github.com/MrYassinox/dev-toolbox/blob/main\DevToolbox\modules\utils.py#L295"><img align="right" style="float:right;" src="https://img.shields.io/badge/-source-cccccc?style=flat-square"></a>
...
<a href="https://github.com/MrYassinox/dev-toolbox/blob/main\DevToolbox\modules\utils.py#L212"><img align="right" style="float:right;" src="https://img.shields.io/badge/-source-cccccc?style=flat-square"></a>
...
<a href="https://github.com/MrYassinox/dev-toolbox/blob/main\DevToolbox\modules\utils.py#L321"><img align="right" style="float:right;" src="https://img.shields.io/badge/-source-cccccc?style=flat-square"></a>
...
<a href="https://github.com/MrYassinox/dev-toolbox/blob/main\DevToolbox\modules\utils.py#L243"><img align="right" style="float:right;" src="https://img.shields.io/badge/-source-cccccc?style=flat-square"></a>
...
<a href="https://github.com/MrYassinox/dev-toolbox/blob/main\DevToolbox\modules\utils.py#L347"><img align="right" style="float:right;" src="https://img.shields.io/badge/-source-cccccc?style=flat-square"></a>
...
<a href="https://github.com/MrYassinox/dev-toolbox/blob/main\DevToolbox\modules\utils.py#L4477"><img align="right" style="float:right;" src="https://img.shields.io/badge/-source-cccccc?style=flat-square"></a>

## <kbd>class</kbd> `TaskTimer`
Task Execution Timer.  

<a href="https://github.com/MrYassinox/dev-toolbox/blob/main\DevToolbox\modules\utils.py#L4479"><img align="right" style="float:right;" src="https://img.shields.io/badge/-source-cccccc?style=flat-square"></a>
...
<a href="https://github.com/MrYassinox/dev-toolbox/blob/main\DevToolbox\modules\utils.py#L4494"><img align="right" style="float:right;" src="https://img.shields.io/badge/-source-cccccc?style=flat-square"></a>
...
<a href="https://github.com/MrYassinox/dev-toolbox/blob/main\DevToolbox\modules\utils.py#L4500"><img align="right" style="float:right;" src="https://img.shields.io/badge/-source-cccccc?style=flat-square"></a>
...
<a href="https://github.com/MrYassinox/dev-toolbox/blob/main\DevToolbox\modules\utils.py#L4488"><img align="right" style="float:right;" src="https://img.shields.io/badge/-source-cccccc?style=flat-square"></a>
...
<a href="https://github.com/MrYassinox/dev-toolbox/blob/main\DevToolbox\modules\utils.py#L4540"><img align="right" style="float:right;" src="https://img.shields.io/badge/-source-cccccc?style=flat-square"></a>

## <kbd>class</kbd> `Threaded`
Threaded  

<a href="https://github.com/MrYassinox/dev-toolbox/blob/main\DevToolbox\modules\utils.py#L4542"><img align="right" style="float:right;" src="https://img.shields.io/badge/-source-cccccc?style=flat-square"></a>
...
<a href="https://github.com/MrYassinox/dev-toolbox/blob/main\DevToolbox\modules\utils.py#L4627"><img align="right" style="float:right;" src="https://img.shields.io/badge/-source-cccccc?style=flat-square"></a>
...
<a href="https://github.com/MrYassinox/dev-toolbox/blob/main\DevToolbox\modules\utils.py#L4581"><img align="right" style="float:right;" src="https://img.shields.io/badge/-source-cccccc?style=flat-square"></a>
...
<a href="https://github.com/MrYassinox/dev-toolbox/blob/main\DevToolbox\modules\utils.py#L4575"><img align="right" style="float:right;" src="https://img.shields.io/badge/-source-cccccc?style=flat-square"></a>
...
<a href="https://github.com/MrYassinox/dev-toolbox/blob/main\DevToolbox\modules\utils.py#L4585"><img align="right" style="float:right;" src="https://img.shields.io/badge/-source-cccccc?style=flat-square"></a>
...
<a href="https://github.com/MrYassinox/dev-toolbox/blob/main\DevToolbox\modules\utils.py#L4607"><img align="right" style="float:right;" src="https://img.shields.io/badge/-source-cccccc?style=flat-square"></a>
...
<a href="https://github.com/MrYassinox/dev-toolbox/blob/main\DevToolbox\modules\utils.py#L4611"><img align="right" style="float:right;" src="https://img.shields.io/badge/-source-cccccc?style=flat-square"></a>
...
<a href="https://github.com/MrYassinox/dev-toolbox/blob/main\DevToolbox\modules\utils.py#L4646"><img align="right" style="float:right;" src="https://img.shields.io/badge/-source-cccccc?style=flat-square"></a>

## <kbd>class</kbd> `ColorsConstants`
Provide RGB color constants and a colors dictionary with elements formatted.  

<a href="https://github.com/MrYassinox/dev-toolbox/blob/main\DevToolbox\modules\utils.py#L4648"><img align="right" style="float:right;" src="https://img.shields.io/badge/-source-cccccc?style=flat-square"></a>
...
<a href="https://github.com/MrYassinox/dev-toolbox/blob/main\DevToolbox\modules\utils.py#L5809"><img align="right" style="float:right;" src="https://img.shields.io/badge/-source-cccccc?style=flat-square"></a>
...
<a href="https://github.com/MrYassinox/dev-toolbox/blob/main\DevToolbox\modules\utils.py#L6382"><img align="right" style="float:right;" src="https://img.shields.io/badge/-source-cccccc?style=flat-square"></a>
...
<a href="https://github.com/MrYassinox/dev-toolbox/blob/main\DevToolbox\modules\utils.py#L6955"><img align="right" style="float:right;" src="https://img.shields.io/badge/-source-cccccc?style=flat-square"></a>
...
<a href="https://github.com/MrYassinox/dev-toolbox/blob/main\DevToolbox\modules\utils.py#L4669"><img align="right" style="float:right;" src="https://img.shields.io/badge/-source-cccccc?style=flat-square"></a>
...
<a href="https://github.com/MrYassinox/dev-toolbox/blob/main\DevToolbox\modules\utils.py#L5239"><img align="right" style="float:right;" src="https://img.shields.io/badge/-source-cccccc?style=flat-square"></a>
...
<a href="https://github.com/MrYassinox/dev-toolbox/blob/main\DevToolbox\modules\utils.py#L7564"><img align="right" style="float:right;" src="https://img.shields.io/badge/-source-cccccc?style=flat-square"></a>

## <kbd>class</kbd> `ColorsConvartor`
Color converter class for different color formats. 

<a href="https://github.com/MrYassinox/dev-toolbox/blob/main\DevToolbox\modules\utils.py#L7566"><img align="right" style="float:right;" src="https://img.shields.io/badge/-source-cccccc?style=flat-square"></a>
...
<a href="https://github.com/MrYassinox/dev-toolbox/blob/main\DevToolbox\modules\utils.py#L7571"><img align="right" style="float:right;" src="https://img.shields.io/badge/-source-cccccc?style=flat-square"></a>
...
<a href="https://github.com/MrYassinox/dev-toolbox/blob/main\DevToolbox\modules\utils.py#L7651"><img align="right" style="float:right;" src="https://img.shields.io/badge/-source-cccccc?style=flat-square"></a>
...
<a href="https://github.com/MrYassinox/dev-toolbox/blob/main\DevToolbox\modules\utils.py#L7692"><img align="right" style="float:right;" src="https://img.shields.io/badge/-source-cccccc?style=flat-square"></a>
...
<a href="https://github.com/MrYassinox/dev-toolbox/blob/main\DevToolbox\modules\utils.py#L7598"><img align="right" style="float:right;" src="https://img.shields.io/badge/-source-cccccc?style=flat-square"></a>
...
<a href="https://github.com/MrYassinox/dev-toolbox/blob/main\DevToolbox\modules\utils.py#L7631"><img align="right" style="float:right;" src="https://img.shields.io/badge/-source-cccccc?style=flat-square"></a>
...
<a href="https://github.com/MrYassinox/dev-toolbox/blob/main\DevToolbox\modules\utils.py#L7671"><img align="right" style="float:right;" src="https://img.shields.io/badge/-source-cccccc?style=flat-square"></a>
...
<a href="https://github.com/MrYassinox/dev-toolbox/blob/main\DevToolbox\modules\utils.py#L7713"><img align="right" style="float:right;" src="https://img.shields.io/badge/-source-cccccc?style=flat-square"></a>

## <kbd>class</kbd> `Image_ColorAverageDominant`
Extract color average and dominant 

<a href="https://github.com/MrYassinox/dev-toolbox/blob/main\DevToolbox\modules\utils.py#L7715"><img align="right" style="float:right;" src="https://img.shields.io/badge/-source-cccccc?style=flat-square"></a>

### <kbd>method</kbd> `__init__`

```python
__init__(logs: Optional[LoggerHandle] = None)
```
...
<a href="https://github.com/MrYassinox/dev-toolbox/blob/main\DevToolbox\modules\utils.py#L7728"><img align="right" style="float:right;" src="https://img.shields.io/badge/-source-cccccc?style=flat-square"></a>

### <kbd>method</kbd> `extract_average_colore`

```python
extract_average_colore(image: str)
```
...
**Args:**
 ...
 - <b>``image` (str)`</b>:  The path to the image. 



**Returns:**
 
 - <b>`tuple[int, int, int]`</b>:  The RGB values of the average color. 



**Raises:**
 
 - <b>`Exception`</b>:  If there is an error processing the image. 
...
<a href="https://github.com/MrYassinox/dev-toolbox/blob/main\DevToolbox\modules\utils.py#L7765"><img align="right" style="float:right;" src="https://img.shields.io/badge/-source-cccccc?style=flat-square"></a>

### <kbd>method</kbd> `extract_dominant_colore`

```python
extract_dominant_colore(
    image: str,
    n_dominant: int = 5,
    show_visualize: bool = False
)
```
...
**Args:**
 ...
 - <b>``image` (str)`</b>:  The path to the image. 
 - <b>``n_dominant` (int, optional)`</b>:  The number of dominant colors to extract. Defaults to `5`. 
 - <b>``show_visualize` (bool, optional)`</b>:  Specifies whether to visualize the dominant colors. Defaults to `False`. 



**Returns:**
 
 - <b>``dict``</b>:  A dictionary containing information about the dominant colors. 
...
<a href="https://github.com/MrYassinox/dev-toolbox/blob/main\DevToolbox\modules\utils.py#L7845"><img align="right" style="float:right;" src="https://img.shields.io/badge/-source-cccccc?style=flat-square"></a>

## <kbd>class</kbd> `AutoCorrection_WhiteBalance`
Auto white balance correction opencv. 

<a href="https://github.com/MrYassinox/dev-toolbox/blob/main\DevToolbox\modules\utils.py#L7847"><img align="right" style="float:right;" src="https://img.shields.io/badge/-source-cccccc?style=flat-square"></a>
...
<a href="https://github.com/MrYassinox/dev-toolbox/blob/main\DevToolbox\modules\utils.py#L7953"><img align="right" style="float:right;" src="https://img.shields.io/badge/-source-cccccc?style=flat-square"></a>
...
gimp(
    image: str,
    type_correction: Literal['world', 'max_white', 'retinex', 'retinex_adjust', 'retinex_with_adjust'] = 'world',
    perc: float = 0.05,
    save: str = None,
    show_visualize: bool = False,
    combining: bool = True
...
**Args:**
 ...
 - <b>``image` (str)`</b>:  The path to the input image file. 
 - <b>``type_correction` (Literal)`</b>:  ['world', 'max_white', 'retinex', 'retinex_adjust', 'retinex_with_adjust']  The type of white balance correction algorithm to use. Default is 'world'. 
 - <b>``perc` (float, optional)`</b>:  The percentile value for contrast enhancement. Default is 0.05. 
 - <b>``save` (str, optional)`</b>:  The path to save the output image. If not provided, the output will not be saved. Defaults to None. 
 - <b>``show_visualize` (bool, optional)`</b>:  Whether to display the visualized output image. Defaults to False. 
 - <b>``combining` (bool, optional)`</b>:  Whether to combine the corrected image with the original image for visualization. Defaults to True. 
...
**Raises:**
 ...
 - <b>`ValueError`</b>:  If an invalid type_correction value is provided. 
...
<a href="https://github.com/MrYassinox/dev-toolbox/blob/main\DevToolbox\modules\utils.py#L7860"><img align="right" style="float:right;" src="https://img.shields.io/badge/-source-cccccc?style=flat-square"></a>

### <kbd>method</kbd> `gray_world`

```python
gray_world(nimg: ndarray)
```
...
<a href="https://github.com/MrYassinox/dev-toolbox/blob/main\DevToolbox\modules\utils.py#L7875"><img align="right" style="float:right;" src="https://img.shields.io/badge/-source-cccccc?style=flat-square"></a>

### <kbd>method</kbd> `max_white`

```python
max_white(nimg: ndarray)
```
...
**Args:**
 ...
 - <b>``nimg` (np.ndarray)`</b>:  _description_ 
...
<a href="https://github.com/MrYassinox/dev-toolbox/blob/main\DevToolbox\modules\utils.py#L7899"><img align="right" style="float:right;" src="https://img.shields.io/badge/-source-cccccc?style=flat-square"></a>

### <kbd>method</kbd> `retinex`

```python
retinex(nimg: ndarray)
```
...
<a href="https://github.com/MrYassinox/dev-toolbox/blob/main\DevToolbox\modules\utils.py#L7914"><img align="right" style="float:right;" src="https://img.shields.io/badge/-source-cccccc?style=flat-square"></a>

### <kbd>method</kbd> `retinex_adjust`

```python
retinex_adjust(nimg: ndarray)
```
...
<a href="https://github.com/MrYassinox/dev-toolbox/blob/main\DevToolbox\modules\utils.py#L7942"><img align="right" style="float:right;" src="https://img.shields.io/badge/-source-cccccc?style=flat-square"></a>

### <kbd>method</kbd> `retinex_with_adjust`

```python
retinex_with_adjust(nimg: ndarray)
```
...
<a href="https://github.com/MrYassinox/dev-toolbox/blob/main\DevToolbox\modules\utils.py#L8036"><img align="right" style="float:right;" src="https://img.shields.io/badge/-source-cccccc?style=flat-square"></a>

## <kbd>class</kbd> `AutoColorMatch`
Automated color matching using histogram matching. 

<a href="https://github.com/MrYassinox/dev-toolbox/blob/main\DevToolbox\modules\utils.py#L8038"><img align="right" style="float:right;" src="https://img.shields.io/badge/-source-cccccc?style=flat-square"></a>
...
<a href="https://github.com/MrYassinox/dev-toolbox/blob/main\DevToolbox\modules\utils.py#L8050"><img align="right" style="float:right;" src="https://img.shields.io/badge/-source-cccccc?style=flat-square"></a>

### <kbd>method</kbd> `color_match`
...
**Args:**
 ...
 - <b>``image` (str)`</b>:  Path to the input image. 
 - <b>``reference` (str)`</b>:  Path to the reference image for color matching. 
 - <b>``save` (str, optional)`</b>:  Path to save the matched image. Defaults to None. 
 - <b>``show_visualize` (bool, optional)`</b>:  Flag indicating whether to display the matched image. Defaults to False. 
 - <b>``compare` (bool, optional)`</b>:  Flag indicating whether to compare the original and matched images. Defaults to False. 
...
**Raises:**
 ...
 - <b>`Exception`</b>:  If an error occurs during the color matching process. 
...
> - Make sure to provide valid paths to the input and reference images. - The input image will be modified in-place with the matched color. - If `save` is specified, the matched image will be saved to the specified path. - If `show_visualize` is True, the matched image will be displayed on the screen. - If `compare` is True, both the original and matched images will be displayed for comparison. 

---

<a href="https://github.com/MrYassinox/dev-toolbox/blob/main\DevToolbox\modules\utils.py#L8114"><img align="right" style="float:right;" src="https://img.shields.io/badge/-source-cccccc?style=flat-square"></a>

### <kbd>method</kbd> `color_match_transfer`

```python
color_match_transfer(
    target: str,
    source: str,
    clip: bool = True,
...
**Args:**
 ...
 - <b>``target` (str)`</b>:  Path to the target image. 
 - <b>``source` (str)`</b>:  Path to the source image for color transfer. 
 - <b>``clip` (bool, optional)`</b>:  Flag indicating whether to scale the L*a*b* image components by np.clip. Defaults to True. 
 - <b>``preserve_paper` (bool, optional)`</b>:  Flag indicating whether to strictly follow the methodology laid out in the original paper. Defaults to True. 
 - <b>``save` (str, optional)`</b>:  Path to save the transferred image. Defaults to None. 
 - <b>``show_visualize` (bool, optional)`</b>:  Flag indicating whether to display the transferred image. Defaults to False. 
 - <b>``compare` (bool, optional)`</b>:  Flag indicating whether to compare the source and transferred images. Defaults to False. 
...
**Raises:**
 ...
 - <b>`Exception`</b>:  If an error occurs during the color transfer process. 
...
> - clip: Should components of L*a*b* image be scaled by np.clip before converting back to BGR color space? If False then components will be min-max scaled appropriately. Clipping will keep target image brightness truer to the input. Scaling will adjust image brightness to avoid washed out portions in the resulting color transfer that can be caused by clipping. - preserve_paper: Should color transfer strictly follow methodology layed out in original paper? The method does not always produce aesthetically pleasing results. If False then L*a*b* components will scaled using the reciprocal of the scaling factor proposed in the paper.  This method seems to produce more consistently aesthetically pleasing results - This method uses the mean and standard deviations of the L*a*b* color space to transfer color distribution. - The `save` parameter specifies the path to save the transferred image. If not provided, the image will not be saved. - The `show_visualize` parameter controls whether to display the transferred image. - The `compare` parameter can be used to compare the source and transferred images side by side. 

---

<a href="https://github.com/MrYassinox/dev-toolbox/blob/main\DevToolbox\modules\utils.py#L8309"><img align="right" style="float:right;" src="https://img.shields.io/badge/-source-cccccc?style=flat-square"></a>

### <kbd>method</kbd> `matplotlib_visualize`

```python
matplotlib_visualize(
    image_one: ndarray,
    image_two: ndarray,
    label_1: str = 'image_one',
    label_2: str = 'image_two',
    width: int = 300,
    compare: bool = False
)
```
...
**Args:**
 ...
 - <b>``image_one` (np.ndarray)`</b>:  First image as a NumPy array. 
 - <b>``image_two` (np.ndarray)`</b>:  Second image as a NumPy array. 
 - <b>``label_1` (str, optional)`</b>:  Label for the first image. Defaults to 'image_one'. 
 - <b>``label_2` (str, optional)`</b>:  Label for the second image. Defaults to 'image_two'. 
 - <b>``width` (int, optional)`</b>:  Width for resizing. Defaults to 300. 
 - <b>``compare` (bool, optional)`</b>:  Flag to compare the images. Defaults to False. 
...
<a href="https://github.com/MrYassinox/dev-toolbox/blob/main\DevToolbox\modules\utils.py#L8292"><img align="right" style="float:right;" src="https://img.shields.io/badge/-source-cccccc?style=flat-square"></a>

### <kbd>method</kbd> `opencv_visualize`

```python
opencv_visualize(image: ndarray, label: str = 'image', width: int = 300)
```
...
**Args:**
 ...
 - <b>``image` (np.ndarray)`</b>:  Image as a NumPy array. 
 - <b>``label` (str, optional)`</b>:  Label for the window. Defaults to 'image'. 
 - <b>``width` (int, optional)`</b>:  Width for resizing. Defaults to 300. 
...
<a href="https://github.com/MrYassinox/dev-toolbox/blob/main\DevToolbox\modules\utils.py#L8353"><img align="right" style="float:right;" src="https://img.shields.io/badge/-source-cccccc?style=flat-square"></a>

### <kbd>method</kbd> `resize_constant`

```python
resize_constant(nimg: ndarray, width: int)
```
...
**Args:**
 ...
 - <b>``nimg` (np.ndarray)`</b>:  Image as a NumPy array. 
 - <b>``width` (int)`</b>:  Desired width for resizing. 



**Returns:**
 
 - <b>`np.ndarray`</b>:  Resized image as a NumPy array. 


---

<a href="https://github.com/MrYassinox/dev-toolbox/blob/main\DevToolbox\modules\utils.py#L8368"><img align="right" style="float:right;" src="https://img.shields.io/badge/-source-cccccc?style=flat-square"></a>

## <kbd>class</kbd> `Promise`
A simplified implementation of promises in Python. 

<a href="https://github.com/MrYassinox/dev-toolbox/blob/main\DevToolbox\modules\utils.py#L8370"><img align="right" style="float:right;" src="https://img.shields.io/badge/-source-cccccc?style=flat-square"></a>
...
<a href="https://github.com/MrYassinox/dev-toolbox/blob/main\DevToolbox\modules\utils.py#L8463"><img align="right" style="float:right;" src="https://img.shields.io/badge/-source-cccccc?style=flat-square"></a>
...
<a href="https://github.com/MrYassinox/dev-toolbox/blob/main\DevToolbox\modules\utils.py#L8487"><img align="right" style="float:right;" src="https://img.shields.io/badge/-source-cccccc?style=flat-square"></a>
...
<a href="https://github.com/MrYassinox/dev-toolbox/blob/main\DevToolbox\modules\utils.py#L8439"><img align="right" style="float:right;" src="https://img.shields.io/badge/-source-cccccc?style=flat-square"></a>
...
<a href="https://github.com/MrYassinox/dev-toolbox/blob/main\DevToolbox\modules\utils.py#L8510"><img align="right" style="float:right;" src="https://img.shields.io/badge/-source-cccccc?style=flat-square"></a>
...
<a href="https://github.com/MrYassinox/dev-toolbox/blob/main\DevToolbox\modules\utils.py#L8744"><img align="right" style="float:right;" src="https://img.shields.io/badge/-source-cccccc?style=flat-square"></a>

## <kbd>class</kbd> `Argparse`
Argparse - Extended Argument Parser for Command-Line Argument Handling.  

<a href="https://github.com/MrYassinox/dev-toolbox/blob/main\DevToolbox\modules\utils.py#L8746"><img align="right" style="float:right;" src="https://img.shields.io/badge/-source-cccccc?style=flat-square"></a>
...
<a href="https://github.com/MrYassinox/dev-toolbox/blob/main\DevToolbox\modules\utils.py#L8817"><img align="right" style="float:right;" src="https://img.shields.io/badge/-source-cccccc?style=flat-square"></a>
...
<a href="https://github.com/MrYassinox/dev-toolbox/blob/main\DevToolbox\modules\utils.py#L8910"><img align="right" style="float:right;" src="https://img.shields.io/badge/-source-cccccc?style=flat-square"></a>
...
<a href="https://github.com/MrYassinox/dev-toolbox/blob/main\DevToolbox\modules\utils.py#L8900"><img align="right" style="float:right;" src="https://img.shields.io/badge/-source-cccccc?style=flat-square"></a>
...
<a href="https://github.com/MrYassinox/dev-toolbox/blob/main\DevToolbox\modules\utils.py#L8920"><img align="right" style="float:right;" src="https://img.shields.io/badge/-source-cccccc?style=flat-square"></a>

## <kbd>class</kbd> `AxisCalc`
Calculate the top, bottom, right, and left coordinates of an object based on its axis. 

<a href="https://github.com/MrYassinox/dev-toolbox/blob/main\DevToolbox\modules\utils.py#L8922"><img align="right" style="float:right;" src="https://img.shields.io/badge/-source-cccccc?style=flat-square"></a>
...
<a href="https://github.com/MrYassinox/dev-toolbox/blob/main\DevToolbox\modules\utils.py#L8970"><img align="right" style="float:right;" src="https://img.shields.io/badge/-source-cccccc?style=flat-square"></a>
...
<a href="https://github.com/MrYassinox/dev-toolbox/blob/main\DevToolbox\modules\utils.py#L8989"><img align="right" style="float:right;" src="https://img.shields.io/badge/-source-cccccc?style=flat-square"></a>
...
<a href="https://github.com/MrYassinox/dev-toolbox/blob/main\DevToolbox\modules\utils.py#L8950"><img align="right" style="float:right;" src="https://img.shields.io/badge/-source-cccccc?style=flat-square"></a>
...
<a href="https://github.com/MrYassinox/dev-toolbox/blob/main\DevToolbox\modules\utils.py#L9008"><img align="right" style="float:right;" src="https://img.shields.io/badge/-source-cccccc?style=flat-square"></a>

## <kbd>class</kbd> `GenerateID`
A class to generate a unique id 

<a href="https://github.com/MrYassinox/dev-toolbox/blob/main\DevToolbox\modules\utils.py#L9010"><img align="right" style="float:right;" src="https://img.shields.io/badge/-source-cccccc?style=flat-square"></a>
...
<a href="https://github.com/MrYassinox/dev-toolbox/blob/main\DevToolbox\modules\utils.py#L9092"><img align="right" style="float:right;" src="https://img.shields.io/badge/-source-cccccc?style=flat-square"></a>
...
<a href="https://github.com/MrYassinox/dev-toolbox/blob/main\DevToolbox\modules\utils.py#L9111"><img align="right" style="float:right;" src="https://img.shields.io/badge/-source-cccccc?style=flat-square"></a>
...
<a href="https://github.com/MrYassinox/dev-toolbox/blob/main\DevToolbox\modules\utils.py#L9068"><img align="right" style="float:right;" src="https://img.shields.io/badge/-source-cccccc?style=flat-square"></a>
...
<a href="https://github.com/MrYassinox/dev-toolbox/blob/main\DevToolbox\modules\utils.py#L9048"><img align="right" style="float:right;" src="https://img.shields.io/badge/-source-cccccc?style=flat-square"></a>
...
<a href="https://github.com/MrYassinox/dev-toolbox/blob/main\DevToolbox\modules\utils.py#L9080"><img align="right" style="float:right;" src="https://img.shields.io/badge/-source-cccccc?style=flat-square"></a>
...
<a href="https://github.com/MrYassinox/dev-toolbox/blob/main\DevToolbox\modules\utils.py#L9130"><img align="right" style="float:right;" src="https://img.shields.io/badge/-source-cccccc?style=flat-square"></a>
...
<a href="https://github.com/MrYassinox/dev-toolbox/blob/main\DevToolbox\modules\utils.py#L9199"><img align="right" style="float:right;" src="https://img.shields.io/badge/-source-cccccc?style=flat-square"></a>
...
<a href="https://github.com/MrYassinox/dev-toolbox/blob/main\DevToolbox\modules\utils.py#L9154"><img align="right" style="float:right;" src="https://img.shields.io/badge/-source-cccccc?style=flat-square"></a>
...
<a href="https://github.com/MrYassinox/dev-toolbox/blob/main\DevToolbox\modules\utils.py#L9212"><img align="right" style="float:right;" src="https://img.shields.io/badge/-source-cccccc?style=flat-square"></a>
...
<a href="https://github.com/MrYassinox/dev-toolbox/blob/main\DevToolbox\modules\utils.py#L9219"><img align="right" style="float:right;" src="https://img.shields.io/badge/-source-cccccc?style=flat-square"></a>
...
<a href="https://github.com/MrYassinox/dev-toolbox/blob/main\DevToolbox\modules\utils.py#L9257"><img align="right" style="float:right;" src="https://img.shields.io/badge/-source-cccccc?style=flat-square"></a>
...
<a href="https://github.com/MrYassinox/dev-toolbox/blob/main\DevToolbox\modules\utils.py#L9283"><img align="right" style="float:right;" src="https://img.shields.io/badge/-source-cccccc?style=flat-square"></a>
...
<a href="https://github.com/MrYassinox/dev-toolbox/blob/main\DevToolbox\modules\utils.py#L9289"><img align="right" style="float:right;" src="https://img.shields.io/badge/-source-cccccc?style=flat-square"></a>
